"""Run workflow for polar-twist EP chain-generation stage."""
...
from mess.experiments.polar_twist_ep.run_chains import run as run_chains
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run chain-generation workflow for polar-twist EP experiment.")
