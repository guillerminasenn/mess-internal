"""Run workflow for source-localization chain-generation stage."""
...
from mess.experiments.narrowband_source_localization.run_chains import run as run_chains
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run chain-generation workflow for source-localization experiment.")
