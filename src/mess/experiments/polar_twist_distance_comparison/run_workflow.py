"""Run workflow for polar-twist distance-comparison chain generation."""
...
from mess.experiments.polar_twist_distance_comparison.run_chains import run as run_chains
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run chain-generation workflow for polar-twist distance comparison.")
