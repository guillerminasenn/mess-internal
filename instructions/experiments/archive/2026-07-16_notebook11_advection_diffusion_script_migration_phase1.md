...
## Scope (Phase 1)
- Add reusable experiment modules under src/mess/experiments/advection_diffusion_dim_sweep_shared_draws_pcn_mpcn.
- Keep job orchestration entrypoint in jobs/AD_toy_dim_M_sweep_shared_draws_pcn_mpcn/run.py as a thin wrapper.
...
- src/mess/experiments/advection_diffusion_dim_sweep_shared_draws_pcn_mpcn/config.py
- src/mess/experiments/advection_diffusion_dim_sweep_shared_draws_pcn_mpcn/run_chains.py
- src/mess/experiments/advection_diffusion_dim_sweep_shared_draws_pcn_mpcn/report_availability.py
- src/mess/experiments/advection_diffusion_dim_sweep_shared_draws_pcn_mpcn/benchmark_runtime.py
- src/mess/experiments/advection_diffusion_dim_sweep_shared_draws_pcn_mpcn/compute_metrics.py
- src/mess/experiments/advection_diffusion_dim_sweep_shared_draws_pcn_mpcn/phase1_all.py
- jobs/AD_toy_dim_M_sweep_shared_draws_pcn_mpcn/run.py

## Expected Usage
- Worker mode (existing launcher compatibility):
  - python jobs/AD_toy_dim_M_sweep_shared_draws_pcn_mpcn/run.py --grid-count 4 --grid-index 0
