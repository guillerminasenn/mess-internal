...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run narrowband source-localization worker wrapper.")
    ...
    from mess.experiments.narrowband_source_localization.run_chains import run
